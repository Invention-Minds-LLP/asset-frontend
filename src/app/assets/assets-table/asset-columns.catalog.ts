...
export const COLUMN_CATALOG: ColumnDef[] = [
  ...
  { key: 'targetDepartmentName', label: 'Target Department', path: 'targetDepartment.name', type: 'text', fallback: '-', filterField: 'targetDepartment' },
  ...
  { key: 'vendorName', label: 'Vendor', path: 'vendor.name', type: 'text', fallback: '-', filterField: 'vendor' },
