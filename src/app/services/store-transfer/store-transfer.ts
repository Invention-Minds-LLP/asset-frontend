...
export class StoreTransferService {
  private base = `${environment.apiUrl}/store-transfer`;
  ...
  markInTransit(id: number): Observable<any> {
    return this.http.patch<any>(`${this.base}/${id}/in-transit`, {});
  }

  receive(id: number, payload: any): Observable<any> {
    return this.http.patch<any>(`${this.base}/${id}/receive`, payload);
  }
